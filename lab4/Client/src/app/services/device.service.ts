...
export class DeviceService {
  ...
  private listDevicesURL = 'https://localhost:8088/listDevices';
  private updateDeviceURL = 'https://localhost:8088/updateDevice';
  private deleteDeviceURL = 'https://localhost:8088/deleteDevice';
  private createDeviceURL = 'https://localhost:8088/createDevice';
  ...
  updateCurrent(device: Device, new_value: number, controlUnit: ControlUnit): void {
    ...
    request.open("POST", "https://localhost:8088/updateCurrent", true);
